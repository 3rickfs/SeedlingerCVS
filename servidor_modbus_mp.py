...
from src.entorno_MODBUS import Config_server_db_brazos,modbus_server_config
...
def update_modbus_input_register(arg:modbus_server_config,data):
    """
    param data el valor de ubicacion [0] no es considerado, por lo cual la informacion debe de estar a partir de la posicion [1]
    """
